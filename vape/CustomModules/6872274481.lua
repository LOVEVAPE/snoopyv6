...
-- Chat hook removed for safety: previously attempted to override
-- DefaultChatSystemChatEvents.OnNewMessage handlers to inject tags.
-- This caused runtime errors in some environments, so it's disabled.
